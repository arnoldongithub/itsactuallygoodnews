...
import { useSubscribeModal } from '@/components/SubscribeModal'; // Import the modal hook
...
const Header = ({ isDarkMode, setIsDarkMode, setIsDonateModalOpen }) => {
  ...
  // CHANGED: Use modal instead of direct Patreon link
  const handleMemberClick = () => {
    openModal(); // Open the subscribe modal instead of going to Patreon
  };
